...
privileged aspect ObjektIntsidendis_Roo_Entity {
    ...
    @Column(name = "id")
    private Long ObjektIntsidendis.id;
    
    @Version
    @Column(name = "version")
    private Integer ObjektIntsidendis.version;
    
    public Long ObjektIntsidendis.getId() {
        return this.id;
    }
    
    public void ObjektIntsidendis.setId(Long id) {
        this.id = id;
    }
    ...
    public void ObjektIntsidendis.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            ObjektIntsidendis attached = ObjektIntsidendis.findObjektIntsidendis(this.id);
