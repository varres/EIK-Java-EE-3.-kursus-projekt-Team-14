...
privileged aspect Intsident_Roo_ToString {
    ...
    public String Intsident.toString() {
        ...
        sb.append("Intsidendi_liik_ID_FK: ").append(getIntsidendi_liik_ID_FK()).append(", ");
        sb.append("Intsident_ID: ").append(getIntsident_ID()).append(", ");
        sb.append("Intsident_ID_FK: ").append(getIntsident_ID_FK()).append(", ");
        ...
        sb.append("Piiriloik_ID_FK: ").append(getPiiriloik_ID_FK()).append(", ");
